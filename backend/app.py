...
"""
  for rsvp in rsvps:
    ...
    boat_from = rsvp["boat_from"]
    boat_from_text = 'Ja' if boat_from else 'Nej'
...
class RSVP(db.Model):
    ...
    boat_from = db.Column(db.Boolean, nullable=False)
...
def rsvp():
    ...
    for rsvp_data in rsvps:
      ...
      boat_from = rsvp_data.get('boat_from')
      ...
      if id is not None:
        ...
        if rsvp_to_update:
            ...
            rsvp_to_update.boat_from = boat_from
